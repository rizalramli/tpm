...
if(isset($_POST['simpan']))
{
    ...
    if($password == $konfirmasi_password)
    {
        ...
        $query_insert = mysqli_query($koneksi, "INSERT INTO karyawan (id_karyawan,nama_karyawan,tgl_diterima,alamat,no_hp,username,password) VALUES ('$id_karyawan','$nama_karyawan','$tgl_diterima','$alamat','$no_hp','$username','$password') ");
        if ($query_insert) {
...
if(isset($_GET['hapus_karyawan']))
{
    ...
    $query_delete = mysqli_query($koneksi,"DELETE FROM detail_karyawan WHERE id_karyawan='$id_karyawan'");
    $query_delete3 = mysqli_query($koneksi,"DELETE FROM detail_absensi WHERE id_karyawan='$id_karyawan'");
    if($query_delete)
    {
        $query_delete2 = mysqli_query($koneksi,"DELETE FROM karyawan WHERE id_karyawan='$id_karyawan'");
        if($query_delete2)
        {
            echo "<script>window.location = 'admin.php?halaman=karyawan'</script>";
        }
...
if(isset($_POST['update']))
{
    ...
    {
        $password = password_hash($password, PASSWORD_DEFAULT); // fungsi mengenkripsi data
        $query_update = mysqli_query($koneksi,"UPDATE karyawan SET nama_karyawan='$nama_karyawan',tgl_diterima='$tgl_diterima',alamat='$alamat',no_hp='$no_hp',username='$username',password='$password' WHERE id_karyawan='$id_karyawan'");
        if ($query_update) {
            // berisi implode
            $nama_karyawan_detail_temp = $_POST['nama_karyawan'].",".$no_hp.",".$id_karyawan;
            $nama_karyawan_detail = addslashes($nama_karyawan_detail_temp);
			...
			<div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" name="alamat"
                                class="form-control form-control-sm" id="inputEmail2"
                                placeholder="Masukan alamat" required value="<?php echo $data['alamat'] ?>">
                                </div>
                            <div class="form-group col-sm-6">
                                <label for="inputEmail2">No Hp </label>
                                <input type="text" name="no_hp"
                                class="form-control form-control-sm hp" id="inputEmail2"
                                placeholder="Masukan nomor hp" value="<?php echo $data['no_hp'] ?>" required>
                            </div>
                            <div class="form-group col-sm-4">
                                <label for="inputEmail2">Username </label>
                                <input type="text" name="username"
